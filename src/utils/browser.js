/**
 * 此工具文件是判断浏览器内核，外壳和版本信息
 * 用法如下：
 * 获取内核：Browser.client.name
 * 获取版本：Browser.client.version
 * 获取外壳：Browser.client.type
 */
const Browser =
  Browser ||
  (function() {
      ...
      System.type = System.isIE
        ...
        : window.opera || agent.indexOf('opr') > 0
          ...
          : agent.indexOf('chrome') > 0
            ? 'Chrome'
            : window.openDatabase // safari也提供了专门的判定方式
              ? 'Safari'
